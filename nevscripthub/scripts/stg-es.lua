...
for scriptName, _ in pairs(mejores) do
...
for _, scriptName in ipairs(sortedScriptNames) do
    local scriptData = mejores[scriptName]
    BestTab:Button{
        Name = scriptName,
        Description = nil,
        Callback = function() 
...
GUI:Notification{
	Title = "Nev | Script Hub",
	Text = "Script cargado exitosamente, versión: " ..NevVer,
	Duration = 3,
...
GUI:Prompt{
	...
	Buttons = {
		ok = function()
            ...
            GUI:Notification{
                Title = "Nev | Script Hub",
                Text = "Copiado el enlace del servidor de Discord en su portapapeles.",
                Duration = 3,
                Callback = function() end
            }
			return true
